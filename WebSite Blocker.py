...
blockButton = Button(window, text="Block site", command=getSiteFromTextAndBlock, bg="red", height=2, width=10, ).place(x =150, y=420)
unblockButton = Button(window, text="Unblock site", command=unblockAll, bg="blue", height=2, width=10).place(x =50, y=420)
